      ...
      <div class="container">
        <div class="card">
            <div class="card-header">
              <a href="#" class="btn btn-primary" @click="addData()">Tambah Transaksi</a>
            </div>
            <div class="card-body">
              ...
              <div class="modal-content">
                <form :action="actionUrl" method="post" autocomplete="off" @submit="submitForm($event, data.id)">
                  ...
                  <div class="modal-body">
                    ...
                    <div class="form-group">
                      <label>Jumlah</label>
                      <input type="number" class="form-control" name="qty" :value="data.qty" placeholder="Jumlah Barang" required>
                    </div>
                  </div>
...
<script type="text/javascript">
  ...
  var columns = [
    ...
    {data: 'users.name', class: 'text-center', orderable: true},
